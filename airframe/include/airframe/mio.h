 ...
 *  turn called repeatedly by mio_dispatch_loop() to process all the records
 *  in each source described by the MIOSource. Application drivers may set
 *  flags (MIO_F_CTL constants) to control the closing of sinks and sources,
 *  the reporting of errors, and termination of the application.
 *
