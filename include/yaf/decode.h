 ...
 *  generator, and are suitable for other similar purposes.
 */
 ...
 * @param vxlanports The ports used to decode VxLAN packets. NULL if VxLAN decoding
 *                   is not enabled.
 * @param geneveports The ports used to decode Geneve packets. NULL if Geneve decoding
 *                   is not enabled.
