 ...
 *  @file
 *
 *  Generic Pickable Queue. A pickable queue's elements may be removed from
 *  any point in the queue, and added to the queue's head or tail. Together
 *  with a hash table to locate mid-queue elements, this can be used to
 *  implement idle timeout of its elements.
 *
