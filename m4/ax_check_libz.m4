dnl Copyright 2004-2023 Carnegie Mellon University
...
AC_DEFUN([AX_CHECK_LIBZ],[
    ...
    then
        ...
        AC_DEFINE([YAF_ENABLE_ZLIB], [1],
            [Define to 1 build with support for zlib compression.
             Requires the libz library and the <zlib.h> header file.])
    fi
])# AX_CHECK_LIBZ
